...
\newgeometry{left=0.35in,right=0.35in,top=0.15in,bottom=0.35in}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%        TITLE          %%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\begin{figure}
\begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
{\LARGE R\Large OMIL \LARGE K\Large ADIA} & {\textit{romil@iitk.ac.in} $\mid$ +91-942-912-0451 \includegraphics[width=15mm]{photo.jpg}}
\vspace{-3em}
\end{tabular*}
...
\resheading{\color{white} \large A\normalsize CADEMIC \large D\normalsize ETAILS}
 \indent 
 \centering 
 \begin{tabular}{ l @{\hskip 0.48in} l @{\hskip 0.48in} l @{\hskip 0.48in} l @{\hskip 0.1in} l }
\hline
...
\item \makebox[\linewidth][s]{Ranked \textbf{1$^{st}$} in \textbf{Bachelor of Engineering} in Department of Mechanical Engineering at LDRP-ITR and awarded} with \textbf{Institute Gold Medal} by Prof. Arvind R. Patel on behalf of Kadva Patidal Kelavni Mandal for the same in 2015.
\item Achieved \textbf{All India Rank 786} in \textbf{GATE, 2016} among 0.21 million mechanical engineering candidates.
...
\item Developing and strengthening contact with \textbf{400+} core companies and inviting them for upcoming placement session.% & internship
...
\item Attended \textbf{Klockner-Desma} and \textbf{IGTR(Indo-German Tool Room)} as part of industrial visit from LDRP-ITR
\end{itemize}
\end{document}