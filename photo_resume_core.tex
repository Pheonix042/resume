...
\end{minipage}}}}
\newgeometry{left=0.35in,right=0.35in,top=0.05in,bottom=0.25in}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%        TITLE          %%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\begin{figure}
...
\item Succeed with \textbf{27$^{th}$} rank in B.E. in Mechanical engineering batch of 2015 at Gujarat Technological University.
...
\begin{itemize}[topsep=0pt]
\setlength{\itemsep}{-3pt}
\item Strength of Material, Solid Mechanics, Molecular Dynamics Simulations, Finite Element Method (Linear, Non-linear), Vibration of Continuous Systems (1D,2D), Advance Dynamics.
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%% POR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tabular*}{7.6in}{l@{\extracolsep{\fill}}r}
\textbf{Department Placement Moderator (ME)}, Student Placement Office & \textit{May'17-Present}\\
\end{tabular*}
